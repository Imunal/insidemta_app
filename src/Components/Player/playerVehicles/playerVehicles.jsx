    ...
    vehicles.map((vehicle) => (
      <div className="col-md-4 mb-3" key={vehicle.ID}>
        <div className="panel__body__element text-center">
          ...
          <br />
          <span className="text-muted text-break">Poj. silnika: {vehicle.engineCapacity}</span>
          <br />
    ...
    <>
      ...
      {playerVehicles.length ? (
        ...
        <div className="custom__alert custom__alert__info">
          ...
          <p className="m-0">
            Jeżeli posiadasz odpowiednią ilość gotówki możesz odwiedzić salon samochodowy i kupić
            swój pierwszy pojazd!
          </p>
        </div>
      )}
    </>
