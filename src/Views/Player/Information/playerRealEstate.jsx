        ...
        <>
            ...
            {playerRealEstate.length ? (
                ...
                <div className="custom__alert custom__alert__info">
                    ...
                    <p className="m-0">
                        Blipy z nieruchomościami rozmieszczone są po całym San Andreas. Jeśli chcesz
                        mieć swój własny kącik i dach nad głową wystarczy, że wynajmiesz posiadłość
                        na dany okres czasu i będziesz pilnować opłat czynszu. To takie proste!
                    </p>
                </div>
            )}
        </>
