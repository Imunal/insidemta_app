    ...
    return playerRealEstate.map((realestate) => (
      <div className="col-md-4 mb-3" key={realestate.ID}>
        <div className="panel__body__element text-center">
          <div className="w-10">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" width="128" style={{color: "#ccc"}}>
          ...
          <p className="text-muted">
            ...
            <br />
            <span className="detail__name">Rozmiar interioru: </span>{realestate.interiorSize}
            <br />
          </p>
        </div>
      </div>
