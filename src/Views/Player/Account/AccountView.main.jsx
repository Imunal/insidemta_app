...
const AccountView = ({
  ...
  const renderPagination = (selectedPaginate) => {
    switch (selectedPaginate) {
      ...
      case 2:
        return <PlayerVehicles playerVehicles={playerVehicles} />;
      case 3:
        return <PlayerRealEstate playerRealEstate={playerRealEstates} />;
      case 4:
...
AccountView.propTypes = {
  playerPersonalToken: PropTypes.string,
  playerVehicles: PropTypes.array,
  playerRealEstates: PropTypes.array,
  playerOrganizations: PropTypes.array,
};
